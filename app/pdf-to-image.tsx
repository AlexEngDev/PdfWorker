        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          >
            ...
            <View style={styles.selectTextWrapper}>
              <Text style={styles.selectTitle}>{pdfUri ? pdfName : 'Select PDF'}</Text>
          ...
          {pages.length > 0 && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                {status === 'done' && (
                  <TouchableOpacity style={styles.saveAllButton} onPress={saveAllToGallery}>
                ...
                renderItem={({ item }) => (
                  <View style={styles.pageCard}>
                    ...
                    <View style={styles.pageOverlay}>
                      <Text style={styles.pageLabel}>Page {item.pageNum}</Text>
          ...
          {status === 'idle' && (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyTitle}>Extract Pages as Images</Text>
