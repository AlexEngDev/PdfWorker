      ...
      >
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <View style={styles.sourceRow}>
            <TouchableOpacity
              style={[styles.sourceButton, { flex: 1, backgroundColor: colors.surface, borderColor: colors.border }]}
            ...
            >
              ...
              <Text style={[styles.sourceLabel, { color: colors.textPrimary }]}>Gallery</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={[styles.sourceLabel, { color: colors.textPrimary }]}>Camera</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <Text style={[styles.cardLabel, { color: colors.textSecondary }]}>Recognition Language</Text>
            <TouchableOpacity
              style={[styles.langSelector, { backgroundColor: colors.surfaceHigh, borderColor: colors.border }]}
              onPress={() => setShowLangPicker((v) => !v)}
              disabled={isProcessing}
            >
              <Ionicons name="language" size={18} color={colors.primary} />
              <Text style={[styles.langSelectorText, { color: colors.textPrimary }]}>{langLabel}</Text>
              <Ionicons
          ...
          {ocrStatus === 'done' && (
            <View style={[styles.resultCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              <View style={styles.resultHeader}>
                <Text style={[styles.cardLabel, { color: colors.textSecondary }]}>Extracted Text</Text>
                <View style={styles.resultActions}>
                  {confidence !== null && (
                    <View style={[styles.confidenceBadge, { backgroundColor: colors.success + '1A' }]}>
